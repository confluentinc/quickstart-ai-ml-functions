...
output "transactions_statement_name" {
  description = "Flink statement name for the transactions faker table"
  value       = confluent_flink_statement.create_transactions.statement_name
}
